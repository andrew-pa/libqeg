...
namespace qeg
{
	...
	//these are unneeded because the shader can get them via reflection
	...
	const D3D11_INPUT_ELEMENT_DESC vertex_position_normal_tangent_texture::d3d_input_layout[] =
	{
		{ "POSITION", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, 0, D3D11_INPUT_PER_VERTEX_DATA, 0 },
		{ "NORMAL", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, D3D11_APPEND_ALIGNED_ELEMENT, D3D11_INPUT_PER_VERTEX_DATA, 0 },
	...
	vector<gl_vertex_attrib> vertex_position_normal_tangent_texture::get_vertex_attribs()
	{
		static vector<gl_vertex_attrib> va =
		{
